...
def creator():
    ...
    while maxi > created:
        if title == "windows":
            system(
                f"title Spotify Account Creator by KevinLage https://github.com/KevinLage/Spotify-Account-Creator Created: {created}/{maxi} Errors:{errors}"
            )
        ...
        try:
            ...
            if '{"status":1,"' in r.text:
                ...
                created += 1
                if title == "windows":
                    system(f"title Spotify Account Creator : {created}/{maxi} Errors:{errors}")
            else:
                errors += 1
        except:
            pass
